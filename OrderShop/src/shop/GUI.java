						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										.addGroup(groupLayout.createSequentialGroup()
											.addComponent(spinnerDessert, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
											.addPreferredGap(ComponentPlacement.RELATED)
										...
										.addGroup(groupLayout.createSequentialGroup()
											.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
												.addComponent(txtMaxFoods, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
												.addGroup(groupLayout.createSequentialGroup()
													.addComponent(spinnerFood, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
													.addPreferredGap(ComponentPlacement.RELATED)
													.addComponent(addFoodButton, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)))
											.addPreferredGap(ComponentPlacement.RELATED))
										.addComponent(txtMaxDesserts, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
										.addComponent(txtMaxBeverages, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
									.addGap(55)
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
